    ...
    class Movement
    {
        ...
        public void MoveP2(Player player1, Player player2)
        {
            ...
            if (player2.ghost1.GhostState[pos.Row, pos.Column] != State.none &&
                player2.ghost1.GhostState[pos2.Row, pos2.Column] != 
                player2.ghost1.GhostState[pos.Row, pos.Column])
            {
            ...
            else Console.WriteLine("You don't have a ghost there or it's the same color");
        }
